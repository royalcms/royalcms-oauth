 ...
 */
class MongoStorage implements \Royalcms\Component\OAuth\Client\StorageInterface
{
    /** @var MongoClient */
    private $mongo;
    ...
    public function getAccessToken($clientConfigId, \Royalcms\Component\OAuth\Client\Context $context)
    {
        ...
        if (null !== $result) {
            ...
            return new \Royalcms\Component\OAuth\Client\AccessToken($result);
        }

        return false;
    }

    public function storeAccessToken(\Royalcms\Component\OAuth\Client\AccessToken $accessToken)
    {
        $collection = $this->mongo->selectCollection($this->db, 'access_tokens');
    ...
    public function deleteAccessToken(\Royalcms\Component\OAuth\Client\AccessToken $accessToken)
    {
        $collection = $this->mongo->selectCollection($this->db, 'access_tokens');
    ...
    public function getRefreshToken($clientConfigId, \Royalcms\Component\OAuth\Client\Context $context)
    {
        ...
        if (null !== $result) {
            ...
            return new \Royalcms\Component\OAuth\Client\RefreshToken($result);
        }

        return false;
    }

    public function storeRefreshToken(\Royalcms\Component\OAuth\Client\RefreshToken $refreshToken)
    {
        $collection = $this->mongo->selectCollection($this->db, 'refresh_tokens');
        $result = $collection->insert(
            array(
    ...
    public function deleteRefreshToken(\Royalcms\Component\OAuth\Client\RefreshToken $refreshToken)
    {
        $collection = $this->mongo->selectCollection($this->db, 'refresh_tokens');
        $result = $collection->remove(
            array(
    ...
    public function getState($clientConfigId, $state)
    {
        ...
        if (null !== $result) {
            ...
            return new \Royalcms\Component\OAuth\Client\State($result);
        }

        return false;
    }

    public function storeState(\Royalcms\Component\OAuth\Client\State $state)
    {
        $collection = $this->mongo->selectCollection($this->db, 'state');
        $result = $collection->insert(
            array(
    ...
    public function deleteStateForContext($clientConfigId, \Royalcms\Component\OAuth\Client\Context $context)
    {
        $collection = $this->mongo->selectCollection($this->db, 'state');
        $result = $collection->remove(
            array(
    ...
    public function deleteState(\Royalcms\Component\OAuth\Client\State $state)
    {
        $collection = $this->mongo->selectCollection($this->db, 'state');
        $result = $collection->remove(
            array(
